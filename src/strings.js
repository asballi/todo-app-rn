...
export const strings = {
  ...
  // Hesap ve senkronizasyon (v4)
  account: {
    title: 'Hesap',
    section: 'Hesap',
    open: 'Hesap',
    notConfigured: 'Senkronizasyon yapılandırılmadı.',
    notConfiguredHelp: 'Bu sürümde sunucu adresi tanımlı değil; görevlerin yalnızca bu cihazda saklanır.',
    signedOutSummary: 'Giriş yapılmadı. Görevlerin yalnızca bu cihazda.',
    signedInSummary: email => `${email} ile eşitleniyor.`,
    expiredSummary: 'Oturumun sona erdi. Eşitleme için yeniden giriş yap.',
    intro: 'Giriş yapınca görevlerin hesabına yüklenir ve diğer cihazlarınla eşitlenir. Bu cihazdaki görevler hesaptakilerle birleşir.',
    email: 'E-posta',
    emailPlaceholder: 'ornek@eposta.com',
    invalidEmail: 'Geçerli bir e-posta adresi yaz.',
    sendCode: 'Kod gönder',
    codeSent: email => `${email} adresine 6 haneli bir kod gönderdik.`,
    code: 'Kod',
    codePlaceholder: '123456',
    invalidCodeFormat: 'Kod 6 haneden oluşur.',
    verify: 'Giriş yap',
    resend: 'Kodu yeniden gönder',
    resendIn: seconds => `Yeniden göndermek için ${seconds} sn`,
    changeEmail: 'E-postayı değiştir',
    errors: {
      invalidCode: 'Kod hatalı ya da süresi geçmiş.',
      rateLimited: 'Çok sık kod istendi. Biraz sonra yeniden dene.',
      network: 'Sunucuya ulaşılamadı. Bağlantını kontrol et.',
    },
    otherAccount: 'Bu cihaz başka bir hesaba bağlı. Farklı bir hesapla girmek için önce çıkış yap.',
    signedInAs: email => `Giriş yapılan hesap: ${email}`,
    expired: 'Oturumun sona erdi. Bekleyen değişikliklerin, aynı hesapla yeniden giriş yapınca gönderilecek.',
    status: {
      syncing: 'Eşitleniyor…',
      idle: 'Eşitlendi.',
      never: 'Henüz eşitlenmedi.',
      lastSynced: time => `Son eşitleme: ${time}`,
      justNow: 'az önce',
      minutesAgo: n => `${n} dk önce`,
      pending: n => `${n} değişiklik gönderilmeyi bekliyor.`,
    ...
    signOut: 'Çıkış yap',
    signOutPendingTitle: 'Gönderilmemiş değişiklikler var',
    signOutPending: n => `${n} değişiklik henüz hesaba gönderilmedi. Çıkarsan kaybolacak.`,
    signOutAnyway: 'Yine de çık',
    signOutHelp: 'Çıkınca bu cihazdaki görevler silinir; hesabındakiler yerinde kalır. Ayarların korunur.',
    deleteAccount: 'Hesabı sil',
    deleteTitle: 'Hesap silinsin mi?',
    deleteMessage: 'Hesabın ve sunucudaki tüm görevlerin kalıcı olarak silinecek; bu cihazdaki görevler de silinir. Saklamak istersen önce Ayarlar → Yedekleme\'den dışa aktar.',
    deleteConfirmTitle: 'Emin misin?',
    deleteConfirmMessage: 'Bu işlem geri alınamaz.',
    deleteConfirm: 'Hesabı kalıcı olarak sil',
    backupFirst: 'Önce yedek al',
    outdatedBanner: 'Senkronizasyon için uygulamayı güncelle.',
    bannerOpen: 'Hesap ayrıntılarını aç',
    bannerDismiss: 'Uyarıyı kapat',
  },
